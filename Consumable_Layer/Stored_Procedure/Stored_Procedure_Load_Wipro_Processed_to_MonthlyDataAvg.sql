CREATE OR REPLACE PROCEDURE "Consumable_Layer"."Stored_Procedure_Load_Wipro_Processed_to_MonthlyDataAvg"()
LANGUAGE 'plpgsql'
AS 
$$
BEGIN
TRUNCATE TABLE "Consumable_Layer"."Wipro_Monthly_Data_Avg";
INSERT INTO "Consumable_Layer"."Wipro_Monthly_Data_Avg"
(
SELECT "Date",
	CONCAT(
		CASE 
			...
			"Price"
			FROM (SELECT "Month_Id",MAX("Date") AS "Date", ROUND (AVG("Price"),2) AS "Price" FROM "Processed_Layer"."Wipro_Processed_Data" GROUP BY 1 ORDER BY 1)	
	);
END;
$$;
