CREATE OR REPLACE PROCEDURE "Consumable_Layer"."Stored_Procedure_Load_Wipro_Processed_to_Daily_Data_QTD"()
language plpgsql
AS 
$$
BEGIN
TRUNCATE TABLE "Consumable_Layer"."Wipro_Daily_Data_QTD";
INSERT INTO "Consumable_Layer"."Wipro_Daily_Data_QTD"
(
WITH a as 
(
	SELECT CASE 
		...
		"Date", 
		"Price" 
		from "Processed_Layer"."Wipro_Processed_Data"
		ORDER BY "Date"),
b as
	(
