CREATE OR REPLACE PROCEDURE "Consumable_Layer"."Stored_Procedure_Load_HCL_Processed_to_Daily_Data_L3M"()
language plpgsql
AS 
$$
BEGIN
TRUNCATE TABLE "Consumable_Layer"."HCL_Daily_Data_L3M" ;
INSERT INTO "Consumable_Layer"."HCL_Daily_Data_L3M" 
SELECT "Date",
	CONCAT (
	...
	CASE 
		...
		"Price" FROM "Processed_Layer"."HCL_Processed_Data"  WHERE "Month_Id" IN (SELECT DISTINCT "Month_Id" FROM "Processed_Layer"."HCL_Processed_Data"   ORDER BY 1 DESC LIMIT 3)
		ORDER BY "Date";
END;
END;
$$;	
