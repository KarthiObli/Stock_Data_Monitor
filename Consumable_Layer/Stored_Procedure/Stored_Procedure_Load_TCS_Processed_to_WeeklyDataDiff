CREATE OR REPLACE PROCEDURE "Consumable_Layer"."Stored_Procedure_Load_TCS_Processed_to_WeeklyDataDiff"()
language plpgsql
as
$$
DECLARE i INTEGER;
...
(SELECT ROW_NUMBER() OVER(),"Date","Weekly_Label", "Price" FROM "Consumable_Layer"."TCS_Weekly_Data" );
i := 1;
j := 2;
TRUNCATE TABLE "Consumable_Layer"."TCS_Weekly_Data_Diff";
WHILE (j<=(SELECT COUNT(*) FROM "Consumable_Layer"."TCS_Weekly_Data"  )) LOOP
INSERT INTO "Consumable_Layer"."TCS_Weekly_Data_Diff"
