CREATE OR REPLACE PROCEDURE "Consumable_Layer"."Stored_Procedure_Load_Wipro_Processed_to_Weekly_DataAvg"()
language plpgsql
AS 
$$
BEGIN
TRUNCATE TABLE "Consumable_Layer"."Wipro_Weekly_Data";
INSERT INTO "Consumable_Layer"."Wipro_Weekly_Data"
(
WITH
a as
	(SELECT DATE_TRUNC ('week', "Date") as week_start,"Date", "Price" FROM "Processed_Layer"."Wipro_Processed_Data" ),	
b as 
	(SELECT "Date",
