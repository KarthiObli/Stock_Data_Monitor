CREATE OR REPLACE PROCEDURE "Consumable_Layer"."Stored_Procedure_Load_TCS_Processed_to_Daily_Data_QTD"()
language plpgsql
AS 
$$
BEGIN
TRUNCATE TABLE "Consumable_Layer"."TCS_Daily_Data_QTD";
INSERT INTO "Consumable_Layer"."TCS_Daily_Data_QTD"
(
WITH a as 
(
	SELECT CASE 
		...
		"Date", 
		"Price" 
		from "Processed_Layer"."TCS_Processed_Data"
		ORDER BY "Date"),
b as
	(
