CREATE OR REPLACE PROCEDURE "Consumable_Layer"."Stored_Procedure_Load_HCL_Processed_to_MonthlyDataDif"()
language plpgsql
as
$$
DECLARE i INTEGER;
...
(SELECT ROW_NUMBER() OVER(),"Date","Monthly_Label", "Price" FROM "Consumable_Layer"."HCL_Monthly_Data");
i := 1;
j := 2;
TRUNCATE TABLE "Consumable_Layer"."HCL_Monthly_Data_Diff";
WHILE (j<=(SELECT COUNT(*) FROM "Consumable_Layer"."HCL_Monthly_Data" )) LOOP
INSERT INTO "Consumable_Layer"."HCL_Monthly_Data_Diff" 
